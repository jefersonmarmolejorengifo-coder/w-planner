  ...
  scrum_master: [
    ...
    },
    {
      ...
      body: [
        ...
        { label: "Cómo se conectan con las tareas", text: "Cada KR tiene fecha inicio y fin (igual que sprints). Las tareas se vinculan a un KR desde el formulario, dropdown filtrado por fecha. Vinculas tareas → el progreso del KR se calcula automáticamente como el promedio del avance real de esas tareas (una Finalizada cuenta 100, una Cancelada no cuenta). Cero manual." },
    ...
    },
    {
      ...
      body: [
        { label: "Qué son", text: "Tres reportes generados por IA y enviados por correo en fechas configuradas. Cada uno tiene audiencia y costo distintos. NO hay envío manual, solo salen en la fecha programada para mantener cadencia y evitar disparos accidentales que inflen el costo." },
        { label: "Reporte Scrum (bi-semanal)", text: "Operativo, para el equipo técnico. Tareas atascadas, próximas a vencer, alertas. Configurable: hasta 2 días por semana (default miércoles 8am + viernes 5pm). Costo ≈ $0.30/proyecto/mes. Tu reporte como SM." },
        { label: "Reporte Semanal del PO (lunes 8am)", text: "Narrativa ejecutiva. Métricas, análisis por persona, recomendaciones de qué hacer la próxima semana. Con caching para abaratar el costo. Costo ≈ $0.40/proyecto/mes. Cadencia fija, no es configurable el día." },
        { label: "Análisis Mensual del Equipo (1er lunes del mes)", text: "Privado, solo para el owner. El más profundo: ejes del equipo, vende-humo, lentos, repetitivos, comparativa con meses anteriores. Costo ≈ $0.12/proyecto/mes." },
  ...
  po: [
    ...
    },
    {
      ...
      body: [
        ...
        { label: "Cómo se conectan con tareas", text: "Cada KR tiene fecha inicio/fin. Vinculas tareas a un KR desde el formulario, dropdown filtrado por fecha de creación (los KRs cuya ventana la contiene aparecen arriba). El progreso del KR se calcula automáticamente: promedio del avance real de las tareas vinculadas (Finalizada cuenta 100, Cancelada no cuenta)." },
    ...
    },
    {
      ...
      body: [
        ...
        { label: "Por qué cada 60 días", text: "Dos razones. Una: 60 días es la ventana mínima para detectar tendencias reales (un solo sprint malo es ruido). Dos: usa el modelo más potente y cada generación cuesta ~$0.34/proyecto. Generar mensualmente cuadruplica costo sin entregar más insight. El gating de 60 días lo enforza la DB." },
    ...
    },
    {
      ...
      body: [
        { label: "Qué es", text: "Conversación en lenguaje natural con una IA cargada con: tu último evolutivo, tus 2 últimos reportes mensuales, estado actual de tareas, comentarios recientes y descripción del proyecto. Solo Enterprise (350k COP/mes)." },
        ...
        { label: "Qué NO responde", text: "Está protegido para hablar SOLO de tu proyecto y tu equipo. Cultura general, historia, recetas, política, deportes, código no relacionado → te redirige con mensaje fijo. No es un chatbot genérico, es un consultor especializado en TU contexto. Esto evita 'fuga' del recurso pago a casos ajenos." },
        { label: "Cuota: 100 mensajes/mes/proyecto", text: "Cada pregunta tuya cuenta 1 mensaje. La cuota se renueva el 1 del mes. Cuando quedan ≤10 ves aviso debajo del input. Al llegar a 0, el input se bloquea hasta el próximo mes. Esto controla el costo (sin tope sería cheque en blanco, $0.05+ por mensaje) y disciplina el uso." },
    ...
    },
    {
      ...
      body: [
        ...
        { label: "Reporte Scrum (bi-semanal)", text: "Para el equipo técnico, no para ti. Tareas atascadas, alertas, próximas a vencer. Hasta 2 días/semana configurables. Puedes desactivarlo en TU correo y dejarlo solo para el equipo si no quieres ruido." },
        { label: "Reporte Semanal del PO (lunes 8am)", text: "TU reporte. Narrativa ejecutiva con análisis por persona, recomendaciones, balance de tipos de tarea. Llega los lunes 8am, léelo antes de planning. Es como si un consultor te dejara un brief sobre la mesa cada lunes." },
        { label: "Análisis Mensual del Equipo (1er lunes del mes)", text: "TU lectura más profunda. PRIVADO, solo owner. Ejes del equipo, vende-humo, lentos, repetitivos, comparativa con meses anteriores. NO compartas este reporte, está escrito asumiendo que tú eres quien decide. Con caching. Costo ≈ $0.12/mes." },
